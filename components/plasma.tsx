...
export const Plasma: React.FC<PlasmaProps> = ({
  ...
  useEffect(() => {
    ...
    // Lower DPR on mobile/iOS for better performance
    const renderer = new Renderer({
      webgl: 2,
      alpha: true,
      antialias: false,
      dpr: Math.min(window.devicePixelRatio || 1, 1.5) * (isIOS || isMobile ? 0.3 : 0.7),
    })
    ...
    const targetFPS = isIOS || isMobile ? 20 : 30 // Reduced FPS for better performance
